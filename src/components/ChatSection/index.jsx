...
import SendIcon from '../../styles/sendicon.svg'
  ...
  return (
    <Section>
      <Buttons>
        ...
        {isConnected && <Button style={{backgroundColor: '#800', marginBottom: '6px'}} onClick={onDisconnect}>Desconectar</Button>}
        {!isConnected && <Button style={{backgroundColor: '#060', marginLeft: 'auto'}} onClick={onConnect}>Conectar</Button>}
      </Buttons>
      <MessagesFeed>
        {chatRows.map((item, i) =>
          <Message key={i}>
